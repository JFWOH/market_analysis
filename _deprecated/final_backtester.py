...
print("Final Backtester - Starting...")

def sanitize_filename(name):
    """Convert a string to a valid filename by removing illegal characters"""
...
class BacktesterIntegrado:
    def __init__(self, ticker, nome_ativo, periodo_inicio='2023-01-01', periodo_fim=None, intervalo='1d'):
        ...
        self.nome_arquivo = sanitize_filename(nome_ativo)  # Sanitized filename
    ...
    def gerar_graficos(self):
        ...
        plt.savefig(os.path.join(pasta_saida, f'{self.nome_arquivo}_preco.png'))
        ...
        # Use sanitized filename
        plt.savefig(os.path.join(pasta_saida, f'{self.nome_arquivo}_equity.png'))
