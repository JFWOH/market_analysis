...
class BacktesterIntegrado:
    ...
    def executar_backtest(self):
        ...
        for i in range(50, len(self.dados)):  # Start after enough data for indicators
            ...
            try:
                ...
                preco = data_slice['Close'].iloc[-1].item()  # Use .item() to convert to scalar
    ...
    def mostrar_resultados(self):
        ...
        if not trades_df.empty:
            ...
            if 'estrategia' in posicao_atual:
                por_estrategia = trades_df.groupby(posicao_atual['estrategia']).size()
...
if __name__ == "__main__":
    executar_backtests()# integrated_backtester.py
import pandas as pd
import numpy as np
import matplotlib.pyplot as plt
import yfinance as yf
